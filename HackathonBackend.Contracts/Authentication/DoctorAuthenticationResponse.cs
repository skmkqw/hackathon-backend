...
public record Doctor(string Id, string FirstName, string LastName, string Email, string Specialization, float Rating, float Experience, string PhoneNumber, Clinic? Clinic);
